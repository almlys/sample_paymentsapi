...
api_v1 = Api( # pylint: disable=invalid-name
    ...
    description=(
        "This is a sample Payments API implemented using Flask-RESTplus using the demo project found [here](https://github.com/frol/flask-restplus-server-example) as the base building block."
    ),
)
